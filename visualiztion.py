...
from hyptraining.datap.processing import (Circle, dataframe_to_tensor, find_circle, resize_image_to_screen, prompt_for_surrounding_points)

def get_arguments():
    ap = ArgumentParser()
    ap.add_argument("--model_path", default="./model/weights.pth",  help="Pretrained model location to use for visualization")
    ap.add_argument("--target_img", default="./trgt_imgs/img.parquet",  help="Location of image to use for visualization.")
...
if __name__ == "__main__":
    ...
    img = dataframe_to_tensor(df, args.image_height, args.image_width)
